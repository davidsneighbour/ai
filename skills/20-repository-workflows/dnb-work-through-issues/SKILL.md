...
```text
~/.ai/skills/20-repository-workflows/dnb-select-next-issue/SKILL.md
```

and:

```text
~/.ai/skills/20-repository-workflows/dnb-work-on-issue/SKILL.md
```
...
```text
~/.ai/skills/20-repository-workflows/dnb-work-on-next-issue/SKILL.md
~/.ai/skills/20-repository-workflows/dnb-work-on-issue/SKILL.md
```
...
1. Run `~/.ai/skills/20-repository-workflows/dnb-select-next-issue/SKILL.md`.
2. If no issue is selected, stop.
3. Extract the selected issue number.
4. Run `~/.ai/skills/20-repository-workflows/dnb-work-on-issue/SKILL.md` with that issue number.
...
6. Pass the selected issue number as the required input.
   ...
   ```text
   Work on issue #123 using ~/.ai/skills/20-repository-workflows/dnb-work-on-issue/SKILL.md.
   ```
