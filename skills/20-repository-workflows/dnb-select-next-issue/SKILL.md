...
This skill is usually called by `~/.ai/skills/20-repository-workflows/dnb-work-on-next-issue/SKILL.md`.
...
Do not use this skill directly when the user already provided a specific issue number. In that case, use `~/.ai/skills/20-repository-workflows/dnb-work-on-issue/SKILL.md`.
