...
Read all 162 items in `references/checklist.md`.
...
Adjust priority using impact, affected scope, exploitability, user harm, frequency, and implementation effort. Explain any departure from the default.
