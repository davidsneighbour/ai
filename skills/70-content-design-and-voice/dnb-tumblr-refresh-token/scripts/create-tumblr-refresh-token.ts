...
function printHelp(): void {
	console.log(`
Create or refresh Tumblr OAuth2 credentials using a loopback-only local
callback server.

Usage:
  node create-tumblr-refresh-token.ts --write-env
...
Options:
  ...
  --redirect-uri <uri>       Loopback redirect URI registered in the Tumblr app.
