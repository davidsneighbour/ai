...
Style: Direct and conversational, no marketing jargon.
Tone: Confident but not pushy.
Audience: CFO at a 200-person company, busy, sceptical of vendor emails.
...
"Attach your reference image to this chat before sending this prompt."
...
- Stable Diffusion: use img2img mode, not txt2img. Set de-noising strength 0.3-0.6 to preserve the original
