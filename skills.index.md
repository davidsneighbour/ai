...
| `10-ai-assets` | Creating, improving, and maintaining prompts, instructions, skills, agents, and other AI assets. | [`dnb-reference`](skills/10-ai-assets/dnb-reference/SKILL.md) |
| `20-repository-workflows` | Repository maintenance, commits, issues, manifests, releases, and working-tree protocols. | [`dnb-dependency-maintenance`](skills/20-repository-workflows/dnb-dependency-maintenance/SKILL.md), [`dnb-osv-scan`](skills/20-repository-workflows/dnb-osv-scan/SKILL.md), [`dnb-project-state-report`](skills/20-repository-workflows/dnb-project-state-report/SKILL.md), [`dnb-project-task-triage`](skills/20-repository-workflows/dnb-project-task-triage/SKILL.md), [`dnb-resume-interrupted-work`](skills/20-repository-workflows/dnb-resume-interrupted-work/SKILL.md), [`dnb-select-next-issue`](skills/20-repository-workflows/dnb-select-next-issue/SKILL.md), [`dnb-work-on-issue`](skills/20-repository-workflows/dnb-work-on-issue/SKILL.md), [`dnb-work-on-next-issue`](skills/20-repository-workflows/dnb-work-on-next-issue/SKILL.md), [`dnb-work-through-issues`](skills/20-repository-workflows/dnb-work-through-issues/SKILL.md) |
...
| [`dnb-post-link-into-void`](skills/70-content-design-and-voice/dnb-post-link-into-void/SKILL.md) | Drafts a Mastodon post from a URL and prevents duplicate link posts. |
