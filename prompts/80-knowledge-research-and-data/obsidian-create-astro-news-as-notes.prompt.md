---
name: prompts-80-knowledge-research-and-data-obsidian-create-astro-news-as-notes
agent: 'agent'
model: Auto
...
`https://raw.githubusercontent.com/withastro/astro.build/refs/heads/main/src/content/blog/<slug>.mdx`

convert it to:

`https://astro.build/blog/<slug>/`
