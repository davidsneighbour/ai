---
name: prompts-20-repository-workflows-markdownlint-config-onboarding
...
- package README.md: it contains additional package information; read the
  README shown on the package page, and read
