---
name: prompts-20-repository-workflows-renovate-config-onboarding
...
- package README.md: it contains additional preset information; read the
  repository `README.md` shown on the package page
